import cat from '../assets/pexels-francesco-ungaro-96428.jpg'
function Top() {
  return (
    <div className="Top">
        <p className='author' tabIndex={0}>Origami</p>
   <img className='cat1' src={cat} alt=''/>
   <div className='aboutHold'>
    <div className='bros'></div>
    <h3 className='about' tabIndex={0}>About Me</h3>
    <p className='aboutInfo' tabIndex={0}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
   <div className='icons'>
